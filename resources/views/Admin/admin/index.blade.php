...
<div class="content-wrapper">
  ...
  <!-- Main content -->
  <div class="content">
    <a href="{{route('admin.create')}}" title="Thêm mới" class="btn btn-success mb-2"><i class="fas fa-plus-square"></i></a>
    <table class="table table-inverse table-hover">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td><a href="{{route('admin.edit',$val->id)}}" class="btn btn-primary float-left" title=""><i class="far fa-edit"></i></a>
