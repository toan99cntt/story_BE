...
<head>
  ...
  <!-- icheck bootstrap -->
  <link rel="stylesheet" href="{{url('public/font-end')}}/plugins/icheck-bootstrap/icheck-bootstrap.min.css">
  <!-- Theme style -->
...
<body class="hold-transition login-page">
  ...
  <!-- AdminLTE App -->
  <script src="{{url('public/font-end')}}/dist/js/adminlte.min.js"></script>
</body>
</html>
