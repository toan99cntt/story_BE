    ...
    <div style="background-image: url('{{url('public/font-end')}}/images/menu (1).png');" class="menu">
      <div class="container">
        <nav class="navbar navbar-expand-lg navbar-light p-1">
          <a class="navbar-brand" href="#"><img src="{{url('public/font-end')}}/images/logo2.png" width="130px" alt=""></a>
              ...
              <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu" >
                  <?php foreach ($genre as $genre): ?>
                    <a class="dropdown-item" href="{{route('list.story.genre',$genre->id)}}">{{$genre->name}}</a>
                  <?php endforeach ?>
                  
                </div>
              </li>
              <li class="nav-item dropdown">
                <a href="" class="nav-link" style="color: #fff" title="">BÀI VIẾT</a>
              </li>
              <li class="nav-item dropdown">
