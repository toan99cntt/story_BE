  ...
  <div class="content">
    <form method="POST" action="{{route('employer.update',$employer->id)}}" enctype="multipart/form-data">
      ...
      <div class="form-group ">
        ...
        <div class="col-sm-10">
          <input type="text" class="form-control" name="username" value="{{$employer->username}}">
          @error('username')
      ...
      <div class="form-group ">
        ...
        <div class="col-sm-10">
          <input type="text" class="form-control" name="password" value="{{$employer->password}}">
          @error('password')
          <small style="color: red">{{$message}}</small>
          @enderror
        </div>
      ...
      <div class="form-group ">
        ...
        <div class="col-sm-10">
          ...
          <img src="{{url('public/images/employer')}}/{{$employer->avatar}}" width="100px" alt="">
          @error('avatar')
          <small style="color: red">{{$message}}</small>
          @enderror
        </div>
      ...
      <div class="form-group">
        <div class="col-sm-offset-2 col-sm-10">
          ...
          <a href="{{route('employer.index')}}" title="" class="btn btn-danger">Trở lại</a>
        </div>
      </div>
    </form>
  </div>
