				...
				<div class="col-md-12 mt-3">
					...
					<form action="{{route('edit.profile.post')}}" method="POST" enctype="multipart/form-data">
						...
						<div class="form-group row">
							...
							<div class="col-sm-8">
								<input type="text" name="username" value="{{Auth::guard('employer')->user()->username}}" class="form-control">
							</div>
						</div>
						...
						<div class="form-group row">
							...
							<div class="col-sm-8">
								<input type="email" name="email" value="{{Auth::guard('employer')->user()->email}}" class="form-control">
							</div>
						</div>
						<div class="form-group row">
						...
						<div class="form-group row">
							<label class="col-sm-4 col-form-label text">Nhập mật khẩu để xác thực</label>
							<div class="col-sm-8">
